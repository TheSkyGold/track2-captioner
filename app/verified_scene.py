...
VERIFIED_OBSERVER_SYSTEM = (
    ...
    "certain. The first claim must state the main subject and central visible action or "
    "state. When clear motion exists, prefer the dynamic action over posture. Prioritize "
    "the main subject, central visible action or state, meaningful "
...
VERIFIER_SYSTEM = (
    ...
    "IDs are dropped. Keep at least one central action or state when visually confirmed, "
    "and prefer a visually confirmed dynamic action to a mere posture when both exist. "
    "Keep only when the complete claim is independently visible in one "
