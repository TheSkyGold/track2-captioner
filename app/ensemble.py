...
_FACT_PARITY_RULE = (
    ...
    "Run a one-for-one coverage audit before returning JSON: for each spine clause, verify "
    "that every caption contains an equivalent factual clause, and revise any caption that "
    "does not. Do not shrink the formal caption to make this audit easier. "
    ...
    "present. Never mention absent or not-visible entities, even to disclaim that they are "
    "off screen. Humor wraps the evidence; it never replaces or expands it. Prefer two to "
...
OBSERVE_SYSTEM = (
    ...
    "verify across the frames. Be EXHAUSTIVE: every subject and appearance (neutral hair "
    "length, curl, or arrangement, "
    ...
    "is clearly visible. NEVER state race/ethnicity/skin color or eye color. Never use an "
    "identity-linked hairstyle label such as 'afro'; say 'curly hair' or 'hair in a bun'. "
    "Do NOT quote a "
...
WRITE_SYSTEM = (
    ...
    "scene, one per style, richly detailed and vivid; do not state race/skin/eye color, and "
    "replace identity-linked hairstyle labels such as 'afro' with neutral visible wording "
    "such as 'curly hair'; do not "
